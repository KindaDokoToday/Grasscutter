...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 90: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              evtBeingHitInfoList_ = new java.util.ArrayList<io.grasscutter.net.proto.fight.EvtBeingHitInfo>();
              mutable_bitField0_ |= 0x00000001;
            }
            evtBeingHitInfoList_.add(
                input.readMessage(io.grasscutter.net.proto.fight.EvtBeingHitInfo.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.grasscutter.net.proto.fight.Fight.internal_static_EvtBeingHitsCombineNotify_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.grasscutter.net.proto.fight.Fight.internal_static_EvtBeingHitsCombineNotify_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify.class, io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify.Builder.class);
  }

  public static final int EVT_BEING_HIT_INFO_LIST_FIELD_NUMBER = 11;
  private java.util.List<io.grasscutter.net.proto.fight.EvtBeingHitInfo> evtBeingHitInfoList_;
  /**
   * <code>repeated .EvtBeingHitInfo evt_being_hit_info_list = 11;</code>
   */
  @java.lang.Override
  public java.util.List<io.grasscutter.net.proto.fight.EvtBeingHitInfo> getEvtBeingHitInfoListList() {
   ...
   */
  @java.lang.Override
  public java.util.List<? extends io.grasscutter.net.proto.fight.EvtBeingHitInfoOrBuilder> 
   ...
   */
  @java.lang.Override
  public io.grasscutter.net.proto.fight.EvtBeingHitInfo getEvtBeingHitInfoList(int index) {
   ...
   */
  @java.lang.Override
  public io.grasscutter.net.proto.fight.EvtBeingHitInfoOrBuilder getEvtBeingHitInfoListOrBuilder(
      int index) {
    return evtBeingHitInfoList_.get(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (int i = 0; i < evtBeingHitInfoList_.size(); i++) {
      output.writeMessage(11, evtBeingHitInfoList_.get(i));
    }
  ...
  public int getSerializedSize() {
    ...
    for (int i = 0; i < evtBeingHitInfoList_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(11, evtBeingHitInfoList_.get(i));
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify)) {
      return super.equals(obj);
    }
    io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify other = (io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify) obj;
  ...
  public static io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify parseFrom(
  ...
  public static io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify parseFrom(
  ...
  public static io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify prototype) {
  ...
  public static final class Builder extends
      ...
      io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotifyOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.grasscutter.net.proto.fight.Fight.internal_static_EvtBeingHitsCombineNotify_descriptor;
    }
    ...
    // Construct using io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify getDefaultInstanceForType() {
      return io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify.getDefaultInstance();
    }

    @java.lang.Override
    public io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify build() {
      io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify result = buildPartial();
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify buildPartial() {
      io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify result = new io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify) {
        return mergeFrom((io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify)other);
      } else {
    ...
    public Builder mergeFrom(io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify other) {
      if (other == io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify.getDefaultInstance()) return this;
      if (evtBeingHitInfoListBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify) e.getUnfinishedMessage();
    ...
    private void ensureEvtBeingHitInfoListIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        evtBeingHitInfoList_ = new java.util.ArrayList<io.grasscutter.net.proto.fight.EvtBeingHitInfo>(evtBeingHitInfoList_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        io.grasscutter.net.proto.fight.EvtBeingHitInfo, io.grasscutter.net.proto.fight.EvtBeingHitInfo.Builder, io.grasscutter.net.proto.fight.EvtBeingHitInfoOrBuilder> evtBeingHitInfoListBuilder_;
    ...
    public Builder setEvtBeingHitInfoList(
        int index, io.grasscutter.net.proto.fight.EvtBeingHitInfo value) {
      if (evtBeingHitInfoListBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setEvtBeingHitInfoList(
        int index, io.grasscutter.net.proto.fight.EvtBeingHitInfo.Builder builderForValue) {
      if (evtBeingHitInfoListBuilder_ == null) {
        ensureEvtBeingHitInfoListIsMutable();
     ...
     * <code>repeated .EvtBeingHitInfo evt_being_hit_info_list = 11;</code>
     */
    public Builder addEvtBeingHitInfoList(io.grasscutter.net.proto.fight.EvtBeingHitInfo value) {
      if (evtBeingHitInfoListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addEvtBeingHitInfoList(
        io.grasscutter.net.proto.fight.EvtBeingHitInfo.Builder builderForValue) {
      if (evtBeingHitInfoListBuilder_ == null) {
        ensureEvtBeingHitInfoListIsMutable();
    ...
    public Builder addAllEvtBeingHitInfoList(
        java.lang.Iterable<? extends io.grasscutter.net.proto.fight.EvtBeingHitInfo> values) {
      if (evtBeingHitInfoListBuilder_ == null) {
        ensureEvtBeingHitInfoListIsMutable();
     ...
     * <code>repeated .EvtBeingHitInfo evt_being_hit_info_list = 11;</code>
     */
    public io.grasscutter.net.proto.fight.EvtBeingHitInfo.Builder getEvtBeingHitInfoListBuilder(
        int index) {
     ...
     * <code>repeated .EvtBeingHitInfo evt_being_hit_info_list = 11;</code>
     */
    public io.grasscutter.net.proto.fight.EvtBeingHitInfo.Builder addEvtBeingHitInfoListBuilder() {
      return getEvtBeingHitInfoListFieldBuilder().addBuilder(
          io.grasscutter.net.proto.fight.EvtBeingHitInfo.getDefaultInstance());
    }
    /**
     * <code>repeated .EvtBeingHitInfo evt_being_hit_info_list = 11;</code>
     */
    public io.grasscutter.net.proto.fight.EvtBeingHitInfo.Builder addEvtBeingHitInfoListBuilder(
        int index) {
      return getEvtBeingHitInfoListFieldBuilder().addBuilder(
          index, io.grasscutter.net.proto.fight.EvtBeingHitInfo.getDefaultInstance());
    }
    /**
     * <code>repeated .EvtBeingHitInfo evt_being_hit_info_list = 11;</code>
     */
    public java.util.List<io.grasscutter.net.proto.fight.EvtBeingHitInfo.Builder> 
         getEvtBeingHitInfoListBuilderList() {
      return getEvtBeingHitInfoListFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        io.grasscutter.net.proto.fight.EvtBeingHitInfo, io.grasscutter.net.proto.fight.EvtBeingHitInfo.Builder, io.grasscutter.net.proto.fight.EvtBeingHitInfoOrBuilder> 
        getEvtBeingHitInfoListFieldBuilder() {
      if (evtBeingHitInfoListBuilder_ == null) {
  ...
  private static final io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify();
  }

  public static io.grasscutter.net.proto.fight.EvtBeingHitsCombineNotify getDefaultInstance() {
