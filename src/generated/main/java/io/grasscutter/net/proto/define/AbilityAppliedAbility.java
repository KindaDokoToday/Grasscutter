...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            abilityOverride_ = input.readMessage(io.grasscutter.net.proto.define.AbilityString.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              overrideMap_ = new java.util.ArrayList<io.grasscutter.net.proto.define.AbilityScalarValueEntry>();
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.grasscutter.net.proto.define.Define.internal_static_AbilityAppliedAbility_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.grasscutter.net.proto.define.Define.internal_static_AbilityAppliedAbility_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.grasscutter.net.proto.define.AbilityAppliedAbility.class, io.grasscutter.net.proto.define.AbilityAppliedAbility.Builder.class);
  }

  public static final int ABILITY_OVERRIDE_FIELD_NUMBER = 2;
  private io.grasscutter.net.proto.define.AbilityString abilityOverride_;
  /**
   ...
   */
  @java.lang.Override
  public io.grasscutter.net.proto.define.AbilityString getAbilityOverride() {
    return abilityOverride_ == null ? io.grasscutter.net.proto.define.AbilityString.getDefaultInstance() : abilityOverride_;
  }
  /**
   * <code>.AbilityString ability_override = 2;</code>
   */
  @java.lang.Override
  public io.grasscutter.net.proto.define.AbilityStringOrBuilder getAbilityOverrideOrBuilder() {
    return getAbilityOverride();
  }

  public static final int OVERRIDE_MAP_FIELD_NUMBER = 3;
  private java.util.List<io.grasscutter.net.proto.define.AbilityScalarValueEntry> overrideMap_;
  /**
   * <code>repeated .AbilityScalarValueEntry override_map = 3;</code>
   */
  @java.lang.Override
  public java.util.List<io.grasscutter.net.proto.define.AbilityScalarValueEntry> getOverrideMapList() {
    return overrideMap_;
  }
  /**
   * <code>repeated .AbilityScalarValueEntry override_map = 3;</code>
   ...
   */
  @java.lang.Override
  public io.grasscutter.net.proto.define.AbilityScalarValueEntry getOverrideMap(int index) {
   ...
   */
  @java.lang.Override
  public io.grasscutter.net.proto.define.AbilityScalarValueEntryOrBuilder getOverrideMapOrBuilder(
      int index) {
    return overrideMap_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.grasscutter.net.proto.define.AbilityAppliedAbility)) {
      return super.equals(obj);
    }
    io.grasscutter.net.proto.define.AbilityAppliedAbility other = (io.grasscutter.net.proto.define.AbilityAppliedAbility) obj;
  ...
  public static io.grasscutter.net.proto.define.AbilityAppliedAbility parseFrom(
  ...
  public static io.grasscutter.net.proto.define.AbilityAppliedAbility parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.grasscutter.net.proto.define.AbilityAppliedAbility parseFrom(
  ...
  public static io.grasscutter.net.proto.define.AbilityAppliedAbility parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.grasscutter.net.proto.define.AbilityAppliedAbility parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static io.grasscutter.net.proto.define.AbilityAppliedAbility parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.grasscutter.net.proto.define.AbilityAppliedAbility prototype) {
  ...
  public static final class Builder extends
      ...
      io.grasscutter.net.proto.define.AbilityAppliedAbilityOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.grasscutter.net.proto.define.Define.internal_static_AbilityAppliedAbility_descriptor;
    }
    ...
    // Construct using io.grasscutter.net.proto.define.AbilityAppliedAbility.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.define.AbilityAppliedAbility getDefaultInstanceForType() {
      return io.grasscutter.net.proto.define.AbilityAppliedAbility.getDefaultInstance();
    }

    @java.lang.Override
    public io.grasscutter.net.proto.define.AbilityAppliedAbility build() {
      io.grasscutter.net.proto.define.AbilityAppliedAbility result = buildPartial();
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.define.AbilityAppliedAbility buildPartial() {
      io.grasscutter.net.proto.define.AbilityAppliedAbility result = new io.grasscutter.net.proto.define.AbilityAppliedAbility(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.grasscutter.net.proto.define.AbilityAppliedAbility) {
        return mergeFrom((io.grasscutter.net.proto.define.AbilityAppliedAbility)other);
      } else {
    ...
    public Builder mergeFrom(io.grasscutter.net.proto.define.AbilityAppliedAbility other) {
      if (other == io.grasscutter.net.proto.define.AbilityAppliedAbility.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.grasscutter.net.proto.define.AbilityAppliedAbility parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.grasscutter.net.proto.define.AbilityAppliedAbility) e.getUnfinishedMessage();
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        io.grasscutter.net.proto.define.AbilityString, io.grasscutter.net.proto.define.AbilityString.Builder, io.grasscutter.net.proto.define.AbilityStringOrBuilder> abilityOverrideBuilder_;
    /**
     * <code>.AbilityString ability_override = 2;</code>
     * @return Whether the abilityOverride field is set.
     */
     ...
     * <code>.AbilityString ability_override = 2;</code>
     */
    public Builder setAbilityOverride(io.grasscutter.net.proto.define.AbilityString value) {
      if (abilityOverrideBuilder_ == null) {
        if (value == null) {
     ...
     * <code>.AbilityString ability_override = 2;</code>
     */
    public Builder mergeAbilityOverride(io.grasscutter.net.proto.define.AbilityString value) {
      if (abilityOverrideBuilder_ == null) {
        if (abilityOverride_ != null) {
          abilityOverride_ =
            io.grasscutter.net.proto.define.AbilityString.newBuilder(abilityOverride_).mergeFrom(value).buildPartial();
        } else {
          abilityOverride_ = value;
        }
        onChanged();
     ...
     * <code>.AbilityString ability_override = 2;</code>
     */
    public io.grasscutter.net.proto.define.AbilityString.Builder getAbilityOverrideBuilder() {
    ...
    public io.grasscutter.net.proto.define.AbilityStringOrBuilder getAbilityOverrideOrBuilder() {
      if (abilityOverrideBuilder_ != null) {
        ...
        return abilityOverride_ == null ?
            io.grasscutter.net.proto.define.AbilityString.getDefaultInstance() : abilityOverride_;
      }
    }
    /**
     * <code>.AbilityString ability_override = 2;</code>
    ...
    private void ensureOverrideMapIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        overrideMap_ = new java.util.ArrayList<io.grasscutter.net.proto.define.AbilityScalarValueEntry>(overrideMap_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        io.grasscutter.net.proto.define.AbilityScalarValueEntry, io.grasscutter.net.proto.define.AbilityScalarValueEntry.Builder, io.grasscutter.net.proto.define.AbilityScalarValueEntryOrBuilder> overrideMapBuilder_;
     ...
     * <code>repeated .AbilityScalarValueEntry override_map = 3;</code>
     */
    public Builder addOverrideMap(io.grasscutter.net.proto.define.AbilityScalarValueEntry value) {
      if (overrideMapBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .AbilityScalarValueEntry override_map = 3;</code>
     */
    public io.grasscutter.net.proto.define.AbilityScalarValueEntry.Builder getOverrideMapBuilder(
        int index) {
     ...
     * <code>repeated .AbilityScalarValueEntry override_map = 3;</code>
     */
    public io.grasscutter.net.proto.define.AbilityScalarValueEntry.Builder addOverrideMapBuilder() {
  ...
  private static final io.grasscutter.net.proto.define.AbilityAppliedAbility DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.grasscutter.net.proto.define.AbilityAppliedAbility();
  }

  public static io.grasscutter.net.proto.define.AbilityAppliedAbility getDefaultInstance() {
