...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.grasscutter.net.proto.scene.Scene.internal_static_ScenePointUnlockNotify_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.grasscutter.net.proto.scene.Scene.internal_static_ScenePointUnlockNotify_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.grasscutter.net.proto.scene.ScenePointUnlockNotify.class, io.grasscutter.net.proto.scene.ScenePointUnlockNotify.Builder.class);
  }
  ...
  public static final int LOCKED_POINT_LIST_FIELD_NUMBER = 12;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.grasscutter.net.proto.scene.ScenePointUnlockNotify)) {
      return super.equals(obj);
    }
    io.grasscutter.net.proto.scene.ScenePointUnlockNotify other = (io.grasscutter.net.proto.scene.ScenePointUnlockNotify) obj;
  ...
  public static io.grasscutter.net.proto.scene.ScenePointUnlockNotify parseFrom(
  ...
  public static io.grasscutter.net.proto.scene.ScenePointUnlockNotify parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.grasscutter.net.proto.scene.ScenePointUnlockNotify parseFrom(
  ...
  public static io.grasscutter.net.proto.scene.ScenePointUnlockNotify parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.grasscutter.net.proto.scene.ScenePointUnlockNotify parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static io.grasscutter.net.proto.scene.ScenePointUnlockNotify parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.grasscutter.net.proto.scene.ScenePointUnlockNotify prototype) {
  ...
  public static final class Builder extends
      ...
      io.grasscutter.net.proto.scene.ScenePointUnlockNotifyOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.grasscutter.net.proto.scene.Scene.internal_static_ScenePointUnlockNotify_descriptor;
    }
    ...
    // Construct using io.grasscutter.net.proto.scene.ScenePointUnlockNotify.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.scene.ScenePointUnlockNotify getDefaultInstanceForType() {
      return io.grasscutter.net.proto.scene.ScenePointUnlockNotify.getDefaultInstance();
    }

    @java.lang.Override
    public io.grasscutter.net.proto.scene.ScenePointUnlockNotify build() {
      io.grasscutter.net.proto.scene.ScenePointUnlockNotify result = buildPartial();
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.scene.ScenePointUnlockNotify buildPartial() {
      io.grasscutter.net.proto.scene.ScenePointUnlockNotify result = new io.grasscutter.net.proto.scene.ScenePointUnlockNotify(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.grasscutter.net.proto.scene.ScenePointUnlockNotify) {
        return mergeFrom((io.grasscutter.net.proto.scene.ScenePointUnlockNotify)other);
      } else {
    ...
    public Builder mergeFrom(io.grasscutter.net.proto.scene.ScenePointUnlockNotify other) {
      if (other == io.grasscutter.net.proto.scene.ScenePointUnlockNotify.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.grasscutter.net.proto.scene.ScenePointUnlockNotify parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.grasscutter.net.proto.scene.ScenePointUnlockNotify) e.getUnfinishedMessage();
  ...
  private static final io.grasscutter.net.proto.scene.ScenePointUnlockNotify DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.grasscutter.net.proto.scene.ScenePointUnlockNotify();
  }

  public static io.grasscutter.net.proto.scene.ScenePointUnlockNotify getDefaultInstance() {
