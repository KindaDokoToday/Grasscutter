...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.grasscutter.net.proto.gacha.Gacha.internal_static_GachaUpInfo_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.grasscutter.net.proto.gacha.Gacha.internal_static_GachaUpInfo_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.grasscutter.net.proto.gacha.GachaUpInfo.class, io.grasscutter.net.proto.gacha.GachaUpInfo.Builder.class);
  }
  ...
  public static final int ITEM_PARENT_TYPE_FIELD_NUMBER = 2;
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (itemParentType_ != 0) {
      output.writeUInt32(2, itemParentType_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (itemParentType_ != 0) {
      size += com.google.protobuf.CodedOutputStream
        .computeUInt32Size(2, itemParentType_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < itemIdList_.size(); i++) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.grasscutter.net.proto.gacha.GachaUpInfo)) {
      return super.equals(obj);
    }
    io.grasscutter.net.proto.gacha.GachaUpInfo other = (io.grasscutter.net.proto.gacha.GachaUpInfo) obj;
  ...
  public static io.grasscutter.net.proto.gacha.GachaUpInfo parseFrom(
  ...
  public static io.grasscutter.net.proto.gacha.GachaUpInfo parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.grasscutter.net.proto.gacha.GachaUpInfo parseFrom(
  ...
  public static io.grasscutter.net.proto.gacha.GachaUpInfo parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.grasscutter.net.proto.gacha.GachaUpInfo parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static io.grasscutter.net.proto.gacha.GachaUpInfo parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.grasscutter.net.proto.gacha.GachaUpInfo prototype) {
  ...
  public static final class Builder extends
      ...
      io.grasscutter.net.proto.gacha.GachaUpInfoOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.grasscutter.net.proto.gacha.Gacha.internal_static_GachaUpInfo_descriptor;
    }
    ...
    // Construct using io.grasscutter.net.proto.gacha.GachaUpInfo.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.gacha.GachaUpInfo getDefaultInstanceForType() {
      return io.grasscutter.net.proto.gacha.GachaUpInfo.getDefaultInstance();
    }

    @java.lang.Override
    public io.grasscutter.net.proto.gacha.GachaUpInfo build() {
      io.grasscutter.net.proto.gacha.GachaUpInfo result = buildPartial();
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.gacha.GachaUpInfo buildPartial() {
      io.grasscutter.net.proto.gacha.GachaUpInfo result = new io.grasscutter.net.proto.gacha.GachaUpInfo(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.grasscutter.net.proto.gacha.GachaUpInfo) {
        return mergeFrom((io.grasscutter.net.proto.gacha.GachaUpInfo)other);
      } else {
    ...
    public Builder mergeFrom(io.grasscutter.net.proto.gacha.GachaUpInfo other) {
      if (other == io.grasscutter.net.proto.gacha.GachaUpInfo.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.grasscutter.net.proto.gacha.GachaUpInfo parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.grasscutter.net.proto.gacha.GachaUpInfo) e.getUnfinishedMessage();
  ...
  private static final io.grasscutter.net.proto.gacha.GachaUpInfo DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.grasscutter.net.proto.gacha.GachaUpInfo();
  }

  public static io.grasscutter.net.proto.gacha.GachaUpInfo getDefaultInstance() {
