...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.grasscutter.net.proto.widget.Widget.internal_static_WidgetThunderBirdFeatherInfo_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.grasscutter.net.proto.widget.Widget.internal_static_WidgetThunderBirdFeatherInfo_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo.class, io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo)) {
      return super.equals(obj);
    }
    io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo other = (io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo) obj;
  ...
  public static io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo parseFrom(
  ...
  public static io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo parseFrom(
  ...
  public static io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo prototype) {
  ...
  public static final class Builder extends
      ...
      io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfoOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.grasscutter.net.proto.widget.Widget.internal_static_WidgetThunderBirdFeatherInfo_descriptor;
    }
    ...
    // Construct using io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo getDefaultInstanceForType() {
      return io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo.getDefaultInstance();
    }

    @java.lang.Override
    public io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo build() {
      io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo result = buildPartial();
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo buildPartial() {
      io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo result = new io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo) {
        return mergeFrom((io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo)other);
      } else {
    ...
    public Builder mergeFrom(io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo other) {
      if (other == io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo) e.getUnfinishedMessage();
  ...
  private static final io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo();
  }

  public static io.grasscutter.net.proto.widget.WidgetThunderBirdFeatherInfo getDefaultInstance() {
