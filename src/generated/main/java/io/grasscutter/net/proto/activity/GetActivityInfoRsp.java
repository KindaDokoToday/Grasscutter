...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 34: {
            if (!((mutable_bitField0_ & 0x00000004) != 0)) {
              disableTransferPointInteractionList_ = new java.util.ArrayList<io.grasscutter.net.proto.define.Uint32Pair>();
          ...
          case 50: {
            if (!((mutable_bitField0_ & 0x00000002) != 0)) {
              activityInfoList_ = new java.util.ArrayList<io.grasscutter.net.proto.activity.ActivityInfo>();
              mutable_bitField0_ |= 0x00000002;
            }
            activityInfoList_.add(
                input.readMessage(io.grasscutter.net.proto.activity.ActivityInfo.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.grasscutter.net.proto.activity.Activity.internal_static_GetActivityInfoRsp_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.grasscutter.net.proto.activity.Activity.internal_static_GetActivityInfoRsp_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.grasscutter.net.proto.activity.GetActivityInfoRsp.class, io.grasscutter.net.proto.activity.GetActivityInfoRsp.Builder.class);
  }
  ...
  public static final int ACTIVITY_INFO_LIST_FIELD_NUMBER = 6;
  private java.util.List<io.grasscutter.net.proto.activity.ActivityInfo> activityInfoList_;
  /**
   * <code>repeated .ActivityInfo activity_info_list = 6;</code>
   */
  @java.lang.Override
  public java.util.List<io.grasscutter.net.proto.activity.ActivityInfo> getActivityInfoListList() {
   ...
   */
  @java.lang.Override
  public java.util.List<? extends io.grasscutter.net.proto.activity.ActivityInfoOrBuilder> 
   ...
   */
  @java.lang.Override
  public io.grasscutter.net.proto.activity.ActivityInfo getActivityInfoList(int index) {
   ...
   */
  @java.lang.Override
  public io.grasscutter.net.proto.activity.ActivityInfoOrBuilder getActivityInfoListOrBuilder(
      int index) {
    return activityInfoList_.get(index);
  }

  public static final int DISABLE_TRANSFER_POINT_INTERACTION_LIST_FIELD_NUMBER = 4;
  private java.util.List<io.grasscutter.net.proto.define.Uint32Pair> disableTransferPointInteractionList_;
  /**
   * <code>repeated .Uint32Pair disable_transfer_point_interaction_list = 4;</code>
   */
  @java.lang.Override
  public java.util.List<io.grasscutter.net.proto.define.Uint32Pair> getDisableTransferPointInteractionListList() {
   ...
   */
  @java.lang.Override
  public io.grasscutter.net.proto.define.Uint32Pair getDisableTransferPointInteractionList(int index) {
   ...
   */
  @java.lang.Override
  public io.grasscutter.net.proto.define.Uint32PairOrBuilder getDisableTransferPointInteractionListOrBuilder(
      int index) {
    return disableTransferPointInteractionList_.get(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (int i = 0; i < activityInfoList_.size(); i++) {
      output.writeMessage(6, activityInfoList_.get(i));
    }
  ...
  public int getSerializedSize() {
    ...
    for (int i = 0; i < activityInfoList_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(6, activityInfoList_.get(i));
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.grasscutter.net.proto.activity.GetActivityInfoRsp)) {
      return super.equals(obj);
    }
    io.grasscutter.net.proto.activity.GetActivityInfoRsp other = (io.grasscutter.net.proto.activity.GetActivityInfoRsp) obj;
  ...
  public static io.grasscutter.net.proto.activity.GetActivityInfoRsp parseFrom(
  ...
  public static io.grasscutter.net.proto.activity.GetActivityInfoRsp parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.grasscutter.net.proto.activity.GetActivityInfoRsp parseFrom(
  ...
  public static io.grasscutter.net.proto.activity.GetActivityInfoRsp parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.grasscutter.net.proto.activity.GetActivityInfoRsp parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static io.grasscutter.net.proto.activity.GetActivityInfoRsp parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.grasscutter.net.proto.activity.GetActivityInfoRsp prototype) {
  ...
  public static final class Builder extends
      ...
      io.grasscutter.net.proto.activity.GetActivityInfoRspOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.grasscutter.net.proto.activity.Activity.internal_static_GetActivityInfoRsp_descriptor;
    }
    ...
    // Construct using io.grasscutter.net.proto.activity.GetActivityInfoRsp.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.activity.GetActivityInfoRsp getDefaultInstanceForType() {
      return io.grasscutter.net.proto.activity.GetActivityInfoRsp.getDefaultInstance();
    }

    @java.lang.Override
    public io.grasscutter.net.proto.activity.GetActivityInfoRsp build() {
      io.grasscutter.net.proto.activity.GetActivityInfoRsp result = buildPartial();
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.activity.GetActivityInfoRsp buildPartial() {
      io.grasscutter.net.proto.activity.GetActivityInfoRsp result = new io.grasscutter.net.proto.activity.GetActivityInfoRsp(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.grasscutter.net.proto.activity.GetActivityInfoRsp) {
        return mergeFrom((io.grasscutter.net.proto.activity.GetActivityInfoRsp)other);
      } else {
    ...
    public Builder mergeFrom(io.grasscutter.net.proto.activity.GetActivityInfoRsp other) {
      if (other == io.grasscutter.net.proto.activity.GetActivityInfoRsp.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.grasscutter.net.proto.activity.GetActivityInfoRsp parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.grasscutter.net.proto.activity.GetActivityInfoRsp) e.getUnfinishedMessage();
    ...
    private void ensureActivityInfoListIsMutable() {
      if (!((bitField0_ & 0x00000002) != 0)) {
        activityInfoList_ = new java.util.ArrayList<io.grasscutter.net.proto.activity.ActivityInfo>(activityInfoList_);
        bitField0_ |= 0x00000002;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        io.grasscutter.net.proto.activity.ActivityInfo, io.grasscutter.net.proto.activity.ActivityInfo.Builder, io.grasscutter.net.proto.activity.ActivityInfoOrBuilder> activityInfoListBuilder_;
    ...
    public Builder setActivityInfoList(
        int index, io.grasscutter.net.proto.activity.ActivityInfo value) {
      if (activityInfoListBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setActivityInfoList(
        int index, io.grasscutter.net.proto.activity.ActivityInfo.Builder builderForValue) {
      if (activityInfoListBuilder_ == null) {
        ensureActivityInfoListIsMutable();
     ...
     * <code>repeated .ActivityInfo activity_info_list = 6;</code>
     */
    public Builder addActivityInfoList(io.grasscutter.net.proto.activity.ActivityInfo value) {
      if (activityInfoListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addAllActivityInfoList(
        java.lang.Iterable<? extends io.grasscutter.net.proto.activity.ActivityInfo> values) {
      if (activityInfoListBuilder_ == null) {
        ensureActivityInfoListIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
     ...
     * <code>repeated .ActivityInfo activity_info_list = 6;</code>
     */
    public io.grasscutter.net.proto.activity.ActivityInfo.Builder getActivityInfoListBuilder(
        int index) {
     ...
     * <code>repeated .ActivityInfo activity_info_list = 6;</code>
     */
    public io.grasscutter.net.proto.activity.ActivityInfo.Builder addActivityInfoListBuilder() {
      return getActivityInfoListFieldBuilder().addBuilder(
          io.grasscutter.net.proto.activity.ActivityInfo.getDefaultInstance());
    }
    /**
     * <code>repeated .ActivityInfo activity_info_list = 6;</code>
     */
    public io.grasscutter.net.proto.activity.ActivityInfo.Builder addActivityInfoListBuilder(
        int index) {
      return getActivityInfoListFieldBuilder().addBuilder(
          index, io.grasscutter.net.proto.activity.ActivityInfo.getDefaultInstance());
    }
    /**
     * <code>repeated .ActivityInfo activity_info_list = 6;</code>
     */
    public java.util.List<io.grasscutter.net.proto.activity.ActivityInfo.Builder> 
    ...
    private void ensureDisableTransferPointInteractionListIsMutable() {
      if (!((bitField0_ & 0x00000004) != 0)) {
        disableTransferPointInteractionList_ = new java.util.ArrayList<io.grasscutter.net.proto.define.Uint32Pair>(disableTransferPointInteractionList_);
        bitField0_ |= 0x00000004;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        io.grasscutter.net.proto.define.Uint32Pair, io.grasscutter.net.proto.define.Uint32Pair.Builder, io.grasscutter.net.proto.define.Uint32PairOrBuilder> disableTransferPointInteractionListBuilder_;
     ...
     * <code>repeated .Uint32Pair disable_transfer_point_interaction_list = 4;</code>
     */
    public Builder addDisableTransferPointInteractionList(io.grasscutter.net.proto.define.Uint32Pair value) {
      if (disableTransferPointInteractionListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .Uint32Pair disable_transfer_point_interaction_list = 4;</code>
     */
    public io.grasscutter.net.proto.define.Uint32Pair.Builder getDisableTransferPointInteractionListBuilder(
        int index) {
     ...
     * <code>repeated .Uint32Pair disable_transfer_point_interaction_list = 4;</code>
     */
    public io.grasscutter.net.proto.define.Uint32Pair.Builder addDisableTransferPointInteractionListBuilder() {
  ...
  private static final io.grasscutter.net.proto.activity.GetActivityInfoRsp DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.grasscutter.net.proto.activity.GetActivityInfoRsp();
  }

  public static io.grasscutter.net.proto.activity.GetActivityInfoRsp getDefaultInstance() {
