...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 26: {
            ...
            fishPoolPos_ = input.readMessage(io.grasscutter.net.proto.define.Vector.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.grasscutter.net.proto.define.Define.internal_static_SceneFishInfo_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.grasscutter.net.proto.define.Define.internal_static_SceneFishInfo_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.grasscutter.net.proto.define.SceneFishInfo.class, io.grasscutter.net.proto.define.SceneFishInfo.Builder.class);
  }

  public static final int FISH_POOL_POS_FIELD_NUMBER = 3;
  private io.grasscutter.net.proto.define.Vector fishPoolPos_;
  /**
   ...
   */
  @java.lang.Override
  public io.grasscutter.net.proto.define.Vector getFishPoolPos() {
    return fishPoolPos_ == null ? io.grasscutter.net.proto.define.Vector.getDefaultInstance() : fishPoolPos_;
  }
  /**
   * <code>.Vector fish_pool_pos = 3;</code>
   */
  @java.lang.Override
  public io.grasscutter.net.proto.define.VectorOrBuilder getFishPoolPosOrBuilder() {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.grasscutter.net.proto.define.SceneFishInfo)) {
      return super.equals(obj);
    }
    io.grasscutter.net.proto.define.SceneFishInfo other = (io.grasscutter.net.proto.define.SceneFishInfo) obj;
  ...
  public static io.grasscutter.net.proto.define.SceneFishInfo parseFrom(
  ...
  public static io.grasscutter.net.proto.define.SceneFishInfo parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.grasscutter.net.proto.define.SceneFishInfo parseFrom(
  ...
  public static io.grasscutter.net.proto.define.SceneFishInfo parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.grasscutter.net.proto.define.SceneFishInfo parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static io.grasscutter.net.proto.define.SceneFishInfo parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.grasscutter.net.proto.define.SceneFishInfo prototype) {
  ...
  public static final class Builder extends
      ...
      io.grasscutter.net.proto.define.SceneFishInfoOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.grasscutter.net.proto.define.Define.internal_static_SceneFishInfo_descriptor;
    }
    ...
    // Construct using io.grasscutter.net.proto.define.SceneFishInfo.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.define.SceneFishInfo getDefaultInstanceForType() {
      return io.grasscutter.net.proto.define.SceneFishInfo.getDefaultInstance();
    }

    @java.lang.Override
    public io.grasscutter.net.proto.define.SceneFishInfo build() {
      io.grasscutter.net.proto.define.SceneFishInfo result = buildPartial();
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.define.SceneFishInfo buildPartial() {
      io.grasscutter.net.proto.define.SceneFishInfo result = new io.grasscutter.net.proto.define.SceneFishInfo(this);
      if (fishPoolPosBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.grasscutter.net.proto.define.SceneFishInfo) {
        return mergeFrom((io.grasscutter.net.proto.define.SceneFishInfo)other);
      } else {
    ...
    public Builder mergeFrom(io.grasscutter.net.proto.define.SceneFishInfo other) {
      if (other == io.grasscutter.net.proto.define.SceneFishInfo.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.grasscutter.net.proto.define.SceneFishInfo parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.grasscutter.net.proto.define.SceneFishInfo) e.getUnfinishedMessage();
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        io.grasscutter.net.proto.define.Vector, io.grasscutter.net.proto.define.Vector.Builder, io.grasscutter.net.proto.define.VectorOrBuilder> fishPoolPosBuilder_;
    /**
     * <code>.Vector fish_pool_pos = 3;</code>
     * @return Whether the fishPoolPos field is set.
     */
     ...
     * <code>.Vector fish_pool_pos = 3;</code>
     */
    public Builder setFishPoolPos(io.grasscutter.net.proto.define.Vector value) {
      if (fishPoolPosBuilder_ == null) {
        if (value == null) {
     ...
     * <code>.Vector fish_pool_pos = 3;</code>
     */
    public Builder mergeFishPoolPos(io.grasscutter.net.proto.define.Vector value) {
      if (fishPoolPosBuilder_ == null) {
        if (fishPoolPos_ != null) {
          fishPoolPos_ =
            io.grasscutter.net.proto.define.Vector.newBuilder(fishPoolPos_).mergeFrom(value).buildPartial();
        } else {
          fishPoolPos_ = value;
        }
        onChanged();
     ...
     * <code>.Vector fish_pool_pos = 3;</code>
     */
    public io.grasscutter.net.proto.define.Vector.Builder getFishPoolPosBuilder() {
    ...
    public io.grasscutter.net.proto.define.VectorOrBuilder getFishPoolPosOrBuilder() {
      if (fishPoolPosBuilder_ != null) {
        ...
        return fishPoolPos_ == null ?
            io.grasscutter.net.proto.define.Vector.getDefaultInstance() : fishPoolPos_;
      }
    }
    /**
     * <code>.Vector fish_pool_pos = 3;</code>
  ...
  private static final io.grasscutter.net.proto.define.SceneFishInfo DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.grasscutter.net.proto.define.SceneFishInfo();
  }

  public static io.grasscutter.net.proto.define.SceneFishInfo getDefaultInstance() {
