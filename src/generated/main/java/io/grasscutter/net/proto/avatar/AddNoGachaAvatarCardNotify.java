 ...
 */
public final class AddNoGachaAvatarCardNotify extends
...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 90: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              transferItemList_ = new java.util.ArrayList<io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItem>();
              mutable_bitField0_ |= 0x00000001;
            }
            transferItemList_.add(
                input.readMessage(io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItem.parser(), extensionRegistry));
            break;
          }
          case 104: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.grasscutter.net.proto.avatar.Avatar.internal_static_AddNoGachaAvatarCardNotify_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.grasscutter.net.proto.avatar.Avatar.internal_static_AddNoGachaAvatarCardNotify_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify.class, io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify.Builder.class);
  }

  public static final int TRANSFER_ITEM_LIST_FIELD_NUMBER = 11;
  private java.util.List<io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItem> transferItemList_;
  /**
   * <code>repeated .AddNoGachaAvatarCardTransferItem transfer_item_list = 11;</code>
   */
  @java.lang.Override
  public java.util.List<io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItem> getTransferItemListList() {
   ...
   */
  @java.lang.Override
  public java.util.List<? extends io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItemOrBuilder> 
   ...
   */
  @java.lang.Override
  public io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItem getTransferItemList(int index) {
   ...
   */
  @java.lang.Override
  public io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItemOrBuilder getTransferItemListOrBuilder(
      int index) {
    return transferItemList_.get(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (int i = 0; i < transferItemList_.size(); i++) {
      output.writeMessage(11, transferItemList_.get(i));
    }
    if (reason_ != 0) {
  ...
  public int getSerializedSize() {
    ...
    for (int i = 0; i < transferItemList_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(11, transferItemList_.get(i));
    }
    if (reason_ != 0) {
      size += com.google.protobuf.CodedOutputStream
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify)) {
      return super.equals(obj);
    }
    io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify other = (io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify) obj;
  ...
  public static io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify parseFrom(
  ...
  public static io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify parseFrom(
  ...
  public static io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify prototype) {
  ...
  public static final class Builder extends
      ...
      io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotifyOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.grasscutter.net.proto.avatar.Avatar.internal_static_AddNoGachaAvatarCardNotify_descriptor;
    }
    ...
    // Construct using io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify getDefaultInstanceForType() {
      return io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify.getDefaultInstance();
    }

    @java.lang.Override
    public io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify build() {
      io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify result = buildPartial();
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify buildPartial() {
      io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify result = new io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify) {
        return mergeFrom((io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify)other);
      } else {
    ...
    public Builder mergeFrom(io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify other) {
      if (other == io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify.getDefaultInstance()) return this;
      if (transferItemListBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify) e.getUnfinishedMessage();
    ...
    private void ensureTransferItemListIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        transferItemList_ = new java.util.ArrayList<io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItem>(transferItemList_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItem, io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItem.Builder, io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItemOrBuilder> transferItemListBuilder_;
    ...
    public Builder setTransferItemList(
        int index, io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItem value) {
      if (transferItemListBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setTransferItemList(
        int index, io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItem.Builder builderForValue) {
      if (transferItemListBuilder_ == null) {
        ensureTransferItemListIsMutable();
     ...
     * <code>repeated .AddNoGachaAvatarCardTransferItem transfer_item_list = 11;</code>
     */
    public Builder addTransferItemList(io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItem value) {
      if (transferItemListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addTransferItemList(
        io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItem.Builder builderForValue) {
      if (transferItemListBuilder_ == null) {
        ensureTransferItemListIsMutable();
    ...
    public Builder addAllTransferItemList(
        java.lang.Iterable<? extends io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItem> values) {
      if (transferItemListBuilder_ == null) {
        ensureTransferItemListIsMutable();
     ...
     * <code>repeated .AddNoGachaAvatarCardTransferItem transfer_item_list = 11;</code>
     */
    public io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItem.Builder getTransferItemListBuilder(
        int index) {
     ...
     * <code>repeated .AddNoGachaAvatarCardTransferItem transfer_item_list = 11;</code>
     */
    public io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItem.Builder addTransferItemListBuilder() {
      return getTransferItemListFieldBuilder().addBuilder(
          io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItem.getDefaultInstance());
    }
    /**
     * <code>repeated .AddNoGachaAvatarCardTransferItem transfer_item_list = 11;</code>
     */
    public io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItem.Builder addTransferItemListBuilder(
        int index) {
      return getTransferItemListFieldBuilder().addBuilder(
          index, io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItem.getDefaultInstance());
    }
    /**
     * <code>repeated .AddNoGachaAvatarCardTransferItem transfer_item_list = 11;</code>
     */
    public java.util.List<io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItem.Builder> 
         getTransferItemListBuilderList() {
      return getTransferItemListFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItem, io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItem.Builder, io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardTransferItemOrBuilder> 
        getTransferItemListFieldBuilder() {
      if (transferItemListBuilder_ == null) {
  ...
  private static final io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify();
  }

  public static io.grasscutter.net.proto.avatar.AddNoGachaAvatarCardNotify getDefaultInstance() {
