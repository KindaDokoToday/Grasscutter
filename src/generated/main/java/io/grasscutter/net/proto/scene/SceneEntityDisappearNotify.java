...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.grasscutter.net.proto.scene.Scene.internal_static_SceneEntityDisappearNotify_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.grasscutter.net.proto.scene.Scene.internal_static_SceneEntityDisappearNotify_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.grasscutter.net.proto.scene.SceneEntityDisappearNotify.class, io.grasscutter.net.proto.scene.SceneEntityDisappearNotify.Builder.class);
  }
  ...
  public static final int DISAPPEAR_TYPE_FIELD_NUMBER = 8;
   ...
   */
  @java.lang.Override public io.grasscutter.net.proto.scene.VisionType getDisappearType() {
    @SuppressWarnings("deprecation")
    io.grasscutter.net.proto.scene.VisionType result = io.grasscutter.net.proto.scene.VisionType.valueOf(disappearType_);
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    getSerializedSize();
    if (disappearType_ != io.grasscutter.net.proto.scene.VisionType.VisionType_VISION_NONE.getNumber()) {
      output.writeEnum(8, disappearType_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (disappearType_ != io.grasscutter.net.proto.scene.VisionType.VisionType_VISION_NONE.getNumber()) {
      size += com.google.protobuf.CodedOutputStream
        .computeEnumSize(8, disappearType_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < entityList_.size(); i++) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.grasscutter.net.proto.scene.SceneEntityDisappearNotify)) {
      return super.equals(obj);
    }
    io.grasscutter.net.proto.scene.SceneEntityDisappearNotify other = (io.grasscutter.net.proto.scene.SceneEntityDisappearNotify) obj;
  ...
  public static io.grasscutter.net.proto.scene.SceneEntityDisappearNotify parseFrom(
  ...
  public static io.grasscutter.net.proto.scene.SceneEntityDisappearNotify parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.grasscutter.net.proto.scene.SceneEntityDisappearNotify parseFrom(
  ...
  public static io.grasscutter.net.proto.scene.SceneEntityDisappearNotify parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.grasscutter.net.proto.scene.SceneEntityDisappearNotify parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static io.grasscutter.net.proto.scene.SceneEntityDisappearNotify parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.grasscutter.net.proto.scene.SceneEntityDisappearNotify prototype) {
  ...
  public static final class Builder extends
      ...
      io.grasscutter.net.proto.scene.SceneEntityDisappearNotifyOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.grasscutter.net.proto.scene.Scene.internal_static_SceneEntityDisappearNotify_descriptor;
    }
    ...
    // Construct using io.grasscutter.net.proto.scene.SceneEntityDisappearNotify.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.scene.SceneEntityDisappearNotify getDefaultInstanceForType() {
      return io.grasscutter.net.proto.scene.SceneEntityDisappearNotify.getDefaultInstance();
    }

    @java.lang.Override
    public io.grasscutter.net.proto.scene.SceneEntityDisappearNotify build() {
      io.grasscutter.net.proto.scene.SceneEntityDisappearNotify result = buildPartial();
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.scene.SceneEntityDisappearNotify buildPartial() {
      io.grasscutter.net.proto.scene.SceneEntityDisappearNotify result = new io.grasscutter.net.proto.scene.SceneEntityDisappearNotify(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.grasscutter.net.proto.scene.SceneEntityDisappearNotify) {
        return mergeFrom((io.grasscutter.net.proto.scene.SceneEntityDisappearNotify)other);
      } else {
    ...
    public Builder mergeFrom(io.grasscutter.net.proto.scene.SceneEntityDisappearNotify other) {
      if (other == io.grasscutter.net.proto.scene.SceneEntityDisappearNotify.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.grasscutter.net.proto.scene.SceneEntityDisappearNotify parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.grasscutter.net.proto.scene.SceneEntityDisappearNotify) e.getUnfinishedMessage();
     ...
     */
    @java.lang.Override
    public io.grasscutter.net.proto.scene.VisionType getDisappearType() {
      @SuppressWarnings("deprecation")
      io.grasscutter.net.proto.scene.VisionType result = io.grasscutter.net.proto.scene.VisionType.valueOf(disappearType_);
      return result == null ? io.grasscutter.net.proto.scene.VisionType.UNRECOGNIZED : result;
    }
     ...
     * @return This builder for chaining.
     */
    public Builder setDisappearType(io.grasscutter.net.proto.scene.VisionType value) {
      if (value == null) {
  ...
  private static final io.grasscutter.net.proto.scene.SceneEntityDisappearNotify DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.grasscutter.net.proto.scene.SceneEntityDisappearNotify();
  }

  public static io.grasscutter.net.proto.scene.SceneEntityDisappearNotify getDefaultInstance() {
