...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 34: {
            if (!((mutable_bitField0_ & 0x00000002) != 0)) {
              stageList_ = new java.util.ArrayList<io.grasscutter.net.proto.activity.BlitzRushStage>();
              mutable_bitField0_ |= 0x00000002;
            }
            stageList_.add(
                input.readMessage(io.grasscutter.net.proto.activity.BlitzRushStage.parser(), extensionRegistry));
            break;
          }
          case 40: {
          ...
          case 114: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              parkourLevelInfoList_ = new java.util.ArrayList<io.grasscutter.net.proto.activity.ParkourLevelInfo>();
              mutable_bitField0_ |= 0x00000001;
            }
            parkourLevelInfoList_.add(
                input.readMessage(io.grasscutter.net.proto.activity.ParkourLevelInfo.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.grasscutter.net.proto.activity.Activity.internal_static_BlitzRushActivityDetailInfo_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.grasscutter.net.proto.activity.Activity.internal_static_BlitzRushActivityDetailInfo_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo.class, io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo.Builder.class);
  }

  public static final int PARKOUR_LEVEL_INFO_LIST_FIELD_NUMBER = 14;
  private java.util.List<io.grasscutter.net.proto.activity.ParkourLevelInfo> parkourLevelInfoList_;
  /**
   * <code>repeated .ParkourLevelInfo parkour_level_info_list = 14;</code>
   */
  @java.lang.Override
  public java.util.List<io.grasscutter.net.proto.activity.ParkourLevelInfo> getParkourLevelInfoListList() {
   ...
   */
  @java.lang.Override
  public java.util.List<? extends io.grasscutter.net.proto.activity.ParkourLevelInfoOrBuilder> 
   ...
   */
  @java.lang.Override
  public io.grasscutter.net.proto.activity.ParkourLevelInfo getParkourLevelInfoList(int index) {
   ...
   */
  @java.lang.Override
  public io.grasscutter.net.proto.activity.ParkourLevelInfoOrBuilder getParkourLevelInfoListOrBuilder(
      int index) {
    return parkourLevelInfoList_.get(index);
  }

  public static final int STAGE_LIST_FIELD_NUMBER = 4;
  private java.util.List<io.grasscutter.net.proto.activity.BlitzRushStage> stageList_;
  /**
   * <code>repeated .BlitzRushStage stage_list = 4;</code>
   */
  @java.lang.Override
  public java.util.List<io.grasscutter.net.proto.activity.BlitzRushStage> getStageListList() {
    return stageList_;
  }
  /**
   * <code>repeated .BlitzRushStage stage_list = 4;</code>
   */
  @java.lang.Override
  public java.util.List<? extends io.grasscutter.net.proto.activity.BlitzRushStageOrBuilder> 
   ...
   */
  @java.lang.Override
  public io.grasscutter.net.proto.activity.BlitzRushStage getStageList(int index) {
   ...
   */
  @java.lang.Override
  public io.grasscutter.net.proto.activity.BlitzRushStageOrBuilder getStageListOrBuilder(
      int index) {
    return stageList_.get(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (int i = 0; i < parkourLevelInfoList_.size(); i++) {
      output.writeMessage(14, parkourLevelInfoList_.get(i));
    }
  ...
  public int getSerializedSize() {
    ...
    for (int i = 0; i < parkourLevelInfoList_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(14, parkourLevelInfoList_.get(i));
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo)) {
      return super.equals(obj);
    }
    io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo other = (io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo) obj;
  ...
  public static io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo parseFrom(
  ...
  public static io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo parseFrom(
  ...
  public static io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo prototype) {
  ...
  public static final class Builder extends
      ...
      io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfoOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.grasscutter.net.proto.activity.Activity.internal_static_BlitzRushActivityDetailInfo_descriptor;
    }
    ...
    // Construct using io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo getDefaultInstanceForType() {
      return io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo.getDefaultInstance();
    }

    @java.lang.Override
    public io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo build() {
      io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo result = buildPartial();
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo buildPartial() {
      io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo result = new io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo) {
        return mergeFrom((io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo)other);
      } else {
    ...
    public Builder mergeFrom(io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo other) {
      if (other == io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo.getDefaultInstance()) return this;
      if (parkourLevelInfoListBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo) e.getUnfinishedMessage();
    ...
    private void ensureParkourLevelInfoListIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        parkourLevelInfoList_ = new java.util.ArrayList<io.grasscutter.net.proto.activity.ParkourLevelInfo>(parkourLevelInfoList_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        io.grasscutter.net.proto.activity.ParkourLevelInfo, io.grasscutter.net.proto.activity.ParkourLevelInfo.Builder, io.grasscutter.net.proto.activity.ParkourLevelInfoOrBuilder> parkourLevelInfoListBuilder_;
    ...
    public Builder setParkourLevelInfoList(
        int index, io.grasscutter.net.proto.activity.ParkourLevelInfo value) {
      if (parkourLevelInfoListBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setParkourLevelInfoList(
        int index, io.grasscutter.net.proto.activity.ParkourLevelInfo.Builder builderForValue) {
      if (parkourLevelInfoListBuilder_ == null) {
        ensureParkourLevelInfoListIsMutable();
     ...
     * <code>repeated .ParkourLevelInfo parkour_level_info_list = 14;</code>
     */
    public Builder addParkourLevelInfoList(io.grasscutter.net.proto.activity.ParkourLevelInfo value) {
      if (parkourLevelInfoListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addParkourLevelInfoList(
        io.grasscutter.net.proto.activity.ParkourLevelInfo.Builder builderForValue) {
      if (parkourLevelInfoListBuilder_ == null) {
        ensureParkourLevelInfoListIsMutable();
    ...
    public Builder addAllParkourLevelInfoList(
        java.lang.Iterable<? extends io.grasscutter.net.proto.activity.ParkourLevelInfo> values) {
      if (parkourLevelInfoListBuilder_ == null) {
        ensureParkourLevelInfoListIsMutable();
     ...
     * <code>repeated .ParkourLevelInfo parkour_level_info_list = 14;</code>
     */
    public io.grasscutter.net.proto.activity.ParkourLevelInfo.Builder getParkourLevelInfoListBuilder(
        int index) {
     ...
     * <code>repeated .ParkourLevelInfo parkour_level_info_list = 14;</code>
     */
    public io.grasscutter.net.proto.activity.ParkourLevelInfo.Builder addParkourLevelInfoListBuilder() {
      return getParkourLevelInfoListFieldBuilder().addBuilder(
          io.grasscutter.net.proto.activity.ParkourLevelInfo.getDefaultInstance());
    }
    /**
     * <code>repeated .ParkourLevelInfo parkour_level_info_list = 14;</code>
     */
    public io.grasscutter.net.proto.activity.ParkourLevelInfo.Builder addParkourLevelInfoListBuilder(
        int index) {
      return getParkourLevelInfoListFieldBuilder().addBuilder(
          index, io.grasscutter.net.proto.activity.ParkourLevelInfo.getDefaultInstance());
    }
    /**
     * <code>repeated .ParkourLevelInfo parkour_level_info_list = 14;</code>
     */
    public java.util.List<io.grasscutter.net.proto.activity.ParkourLevelInfo.Builder> 
         getParkourLevelInfoListBuilderList() {
      return getParkourLevelInfoListFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        io.grasscutter.net.proto.activity.ParkourLevelInfo, io.grasscutter.net.proto.activity.ParkourLevelInfo.Builder, io.grasscutter.net.proto.activity.ParkourLevelInfoOrBuilder> 
        getParkourLevelInfoListFieldBuilder() {
      if (parkourLevelInfoListBuilder_ == null) {
    ...
    private void ensureStageListIsMutable() {
      if (!((bitField0_ & 0x00000002) != 0)) {
        stageList_ = new java.util.ArrayList<io.grasscutter.net.proto.activity.BlitzRushStage>(stageList_);
        bitField0_ |= 0x00000002;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        io.grasscutter.net.proto.activity.BlitzRushStage, io.grasscutter.net.proto.activity.BlitzRushStage.Builder, io.grasscutter.net.proto.activity.BlitzRushStageOrBuilder> stageListBuilder_;
    ...
    public Builder setStageList(
        int index, io.grasscutter.net.proto.activity.BlitzRushStage value) {
      if (stageListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setStageList(
        int index, io.grasscutter.net.proto.activity.BlitzRushStage.Builder builderForValue) {
      if (stageListBuilder_ == null) {
        ensureStageListIsMutable();
     ...
     * <code>repeated .BlitzRushStage stage_list = 4;</code>
     */
    public Builder addStageList(io.grasscutter.net.proto.activity.BlitzRushStage value) {
      if (stageListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addStageList(
        io.grasscutter.net.proto.activity.BlitzRushStage.Builder builderForValue) {
      if (stageListBuilder_ == null) {
        ensureStageListIsMutable();
    ...
    public Builder addAllStageList(
        java.lang.Iterable<? extends io.grasscutter.net.proto.activity.BlitzRushStage> values) {
      if (stageListBuilder_ == null) {
        ensureStageListIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, stageList_);
     ...
     * <code>repeated .BlitzRushStage stage_list = 4;</code>
     */
    public io.grasscutter.net.proto.activity.BlitzRushStage.Builder getStageListBuilder(
        int index) {
     ...
     * <code>repeated .BlitzRushStage stage_list = 4;</code>
     */
    public io.grasscutter.net.proto.activity.BlitzRushStage.Builder addStageListBuilder() {
      return getStageListFieldBuilder().addBuilder(
          io.grasscutter.net.proto.activity.BlitzRushStage.getDefaultInstance());
    }
    /**
     * <code>repeated .BlitzRushStage stage_list = 4;</code>
     */
    public io.grasscutter.net.proto.activity.BlitzRushStage.Builder addStageListBuilder(
        int index) {
      return getStageListFieldBuilder().addBuilder(
          index, io.grasscutter.net.proto.activity.BlitzRushStage.getDefaultInstance());
    }
    /**
     * <code>repeated .BlitzRushStage stage_list = 4;</code>
     */
    public java.util.List<io.grasscutter.net.proto.activity.BlitzRushStage.Builder> 
         getStageListBuilderList() {
      return getStageListFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        io.grasscutter.net.proto.activity.BlitzRushStage, io.grasscutter.net.proto.activity.BlitzRushStage.Builder, io.grasscutter.net.proto.activity.BlitzRushStageOrBuilder> 
        getStageListFieldBuilder() {
      if (stageListBuilder_ == null) {
  ...
  private static final io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo();
  }

  public static io.grasscutter.net.proto.activity.BlitzRushActivityDetailInfo getDefaultInstance() {
