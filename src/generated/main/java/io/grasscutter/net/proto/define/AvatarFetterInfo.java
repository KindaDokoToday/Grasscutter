...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 50: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              fetterList_ = new java.util.ArrayList<io.grasscutter.net.proto.define.FetterData>();
              mutable_bitField0_ |= 0x00000001;
            }
            fetterList_.add(
                input.readMessage(io.grasscutter.net.proto.define.FetterData.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.grasscutter.net.proto.define.Define.internal_static_AvatarFetterInfo_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.grasscutter.net.proto.define.Define.internal_static_AvatarFetterInfo_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.grasscutter.net.proto.define.AvatarFetterInfo.class, io.grasscutter.net.proto.define.AvatarFetterInfo.Builder.class);
  }

  public static final int FETTER_LIST_FIELD_NUMBER = 6;
  private java.util.List<io.grasscutter.net.proto.define.FetterData> fetterList_;
  /**
   * <code>repeated .FetterData fetter_list = 6;</code>
   */
  @java.lang.Override
  public java.util.List<io.grasscutter.net.proto.define.FetterData> getFetterListList() {
    return fetterList_;
  }
  /**
   * <code>repeated .FetterData fetter_list = 6;</code>
   */
  @java.lang.Override
  public java.util.List<? extends io.grasscutter.net.proto.define.FetterDataOrBuilder> 
   ...
   */
  @java.lang.Override
  public io.grasscutter.net.proto.define.FetterData getFetterList(int index) {
   ...
   */
  @java.lang.Override
  public io.grasscutter.net.proto.define.FetterDataOrBuilder getFetterListOrBuilder(
      int index) {
    return fetterList_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.grasscutter.net.proto.define.AvatarFetterInfo)) {
      return super.equals(obj);
    }
    io.grasscutter.net.proto.define.AvatarFetterInfo other = (io.grasscutter.net.proto.define.AvatarFetterInfo) obj;
  ...
  public static io.grasscutter.net.proto.define.AvatarFetterInfo parseFrom(
  ...
  public static io.grasscutter.net.proto.define.AvatarFetterInfo parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.grasscutter.net.proto.define.AvatarFetterInfo parseFrom(
  ...
  public static io.grasscutter.net.proto.define.AvatarFetterInfo parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.grasscutter.net.proto.define.AvatarFetterInfo parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static io.grasscutter.net.proto.define.AvatarFetterInfo parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.grasscutter.net.proto.define.AvatarFetterInfo prototype) {
  ...
  public static final class Builder extends
      ...
      io.grasscutter.net.proto.define.AvatarFetterInfoOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.grasscutter.net.proto.define.Define.internal_static_AvatarFetterInfo_descriptor;
    }
    ...
    // Construct using io.grasscutter.net.proto.define.AvatarFetterInfo.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.define.AvatarFetterInfo getDefaultInstanceForType() {
      return io.grasscutter.net.proto.define.AvatarFetterInfo.getDefaultInstance();
    }

    @java.lang.Override
    public io.grasscutter.net.proto.define.AvatarFetterInfo build() {
      io.grasscutter.net.proto.define.AvatarFetterInfo result = buildPartial();
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.define.AvatarFetterInfo buildPartial() {
      io.grasscutter.net.proto.define.AvatarFetterInfo result = new io.grasscutter.net.proto.define.AvatarFetterInfo(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.grasscutter.net.proto.define.AvatarFetterInfo) {
        return mergeFrom((io.grasscutter.net.proto.define.AvatarFetterInfo)other);
      } else {
    ...
    public Builder mergeFrom(io.grasscutter.net.proto.define.AvatarFetterInfo other) {
      if (other == io.grasscutter.net.proto.define.AvatarFetterInfo.getDefaultInstance()) return this;
      if (fetterListBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.grasscutter.net.proto.define.AvatarFetterInfo parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.grasscutter.net.proto.define.AvatarFetterInfo) e.getUnfinishedMessage();
    ...
    private void ensureFetterListIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        fetterList_ = new java.util.ArrayList<io.grasscutter.net.proto.define.FetterData>(fetterList_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        io.grasscutter.net.proto.define.FetterData, io.grasscutter.net.proto.define.FetterData.Builder, io.grasscutter.net.proto.define.FetterDataOrBuilder> fetterListBuilder_;
    ...
    public Builder setFetterList(
        int index, io.grasscutter.net.proto.define.FetterData value) {
      if (fetterListBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setFetterList(
        int index, io.grasscutter.net.proto.define.FetterData.Builder builderForValue) {
      if (fetterListBuilder_ == null) {
        ensureFetterListIsMutable();
     ...
     * <code>repeated .FetterData fetter_list = 6;</code>
     */
    public Builder addFetterList(io.grasscutter.net.proto.define.FetterData value) {
      if (fetterListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addFetterList(
        io.grasscutter.net.proto.define.FetterData.Builder builderForValue) {
      if (fetterListBuilder_ == null) {
        ensureFetterListIsMutable();
    ...
    public Builder addAllFetterList(
        java.lang.Iterable<? extends io.grasscutter.net.proto.define.FetterData> values) {
      if (fetterListBuilder_ == null) {
        ensureFetterListIsMutable();
     ...
     * <code>repeated .FetterData fetter_list = 6;</code>
     */
    public io.grasscutter.net.proto.define.FetterData.Builder getFetterListBuilder(
        int index) {
     ...
     * <code>repeated .FetterData fetter_list = 6;</code>
     */
    public io.grasscutter.net.proto.define.FetterData.Builder addFetterListBuilder() {
      return getFetterListFieldBuilder().addBuilder(
          io.grasscutter.net.proto.define.FetterData.getDefaultInstance());
    }
    /**
     * <code>repeated .FetterData fetter_list = 6;</code>
     */
    public io.grasscutter.net.proto.define.FetterData.Builder addFetterListBuilder(
        int index) {
      return getFetterListFieldBuilder().addBuilder(
          index, io.grasscutter.net.proto.define.FetterData.getDefaultInstance());
    }
    /**
     * <code>repeated .FetterData fetter_list = 6;</code>
     */
    public java.util.List<io.grasscutter.net.proto.define.FetterData.Builder> 
         getFetterListBuilderList() {
      return getFetterListFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        io.grasscutter.net.proto.define.FetterData, io.grasscutter.net.proto.define.FetterData.Builder, io.grasscutter.net.proto.define.FetterDataOrBuilder> 
        getFetterListFieldBuilder() {
      if (fetterListBuilder_ == null) {
  ...
  private static final io.grasscutter.net.proto.define.AvatarFetterInfo DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.grasscutter.net.proto.define.AvatarFetterInfo();
  }

  public static io.grasscutter.net.proto.define.AvatarFetterInfo getDefaultInstance() {
