...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 114: {
            io.grasscutter.net.proto.multistage_play.IrodoriChessEntranceDetailInfo.Builder subBuilder = null;
            if (entranceDetailInfo_ != null) {
              subBuilder = entranceDetailInfo_.toBuilder();
            }
            entranceDetailInfo_ = input.readMessage(io.grasscutter.net.proto.multistage_play.IrodoriChessEntranceDetailInfo.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.grasscutter.net.proto.activity.Activity.internal_static_IrodoriChessMapData_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.grasscutter.net.proto.activity.Activity.internal_static_IrodoriChessMapData_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.grasscutter.net.proto.activity.IrodoriChessMapData.class, io.grasscutter.net.proto.activity.IrodoriChessMapData.Builder.class);
  }

  public static final int ENTRANCE_DETAIL_INFO_FIELD_NUMBER = 14;
  private io.grasscutter.net.proto.multistage_play.IrodoriChessEntranceDetailInfo entranceDetailInfo_;
  /**
   ...
   */
  @java.lang.Override
  public io.grasscutter.net.proto.multistage_play.IrodoriChessEntranceDetailInfo getEntranceDetailInfo() {
    return entranceDetailInfo_ == null ? io.grasscutter.net.proto.multistage_play.IrodoriChessEntranceDetailInfo.getDefaultInstance() : entranceDetailInfo_;
  }
  /**
   * <code>.IrodoriChessEntranceDetailInfo entrance_detail_info = 14;</code>
   */
  @java.lang.Override
  public io.grasscutter.net.proto.multistage_play.IrodoriChessEntranceDetailInfoOrBuilder getEntranceDetailInfoOrBuilder() {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.grasscutter.net.proto.activity.IrodoriChessMapData)) {
      return super.equals(obj);
    }
    io.grasscutter.net.proto.activity.IrodoriChessMapData other = (io.grasscutter.net.proto.activity.IrodoriChessMapData) obj;
  ...
  public static io.grasscutter.net.proto.activity.IrodoriChessMapData parseFrom(
  ...
  public static io.grasscutter.net.proto.activity.IrodoriChessMapData parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.grasscutter.net.proto.activity.IrodoriChessMapData parseFrom(
  ...
  public static io.grasscutter.net.proto.activity.IrodoriChessMapData parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.grasscutter.net.proto.activity.IrodoriChessMapData parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static io.grasscutter.net.proto.activity.IrodoriChessMapData parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.grasscutter.net.proto.activity.IrodoriChessMapData prototype) {
  ...
  public static final class Builder extends
      ...
      io.grasscutter.net.proto.activity.IrodoriChessMapDataOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.grasscutter.net.proto.activity.Activity.internal_static_IrodoriChessMapData_descriptor;
    }
    ...
    // Construct using io.grasscutter.net.proto.activity.IrodoriChessMapData.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.activity.IrodoriChessMapData getDefaultInstanceForType() {
      return io.grasscutter.net.proto.activity.IrodoriChessMapData.getDefaultInstance();
    }

    @java.lang.Override
    public io.grasscutter.net.proto.activity.IrodoriChessMapData build() {
      io.grasscutter.net.proto.activity.IrodoriChessMapData result = buildPartial();
    ...
    @java.lang.Override
    public io.grasscutter.net.proto.activity.IrodoriChessMapData buildPartial() {
      io.grasscutter.net.proto.activity.IrodoriChessMapData result = new io.grasscutter.net.proto.activity.IrodoriChessMapData(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.grasscutter.net.proto.activity.IrodoriChessMapData) {
        return mergeFrom((io.grasscutter.net.proto.activity.IrodoriChessMapData)other);
      } else {
    ...
    public Builder mergeFrom(io.grasscutter.net.proto.activity.IrodoriChessMapData other) {
      if (other == io.grasscutter.net.proto.activity.IrodoriChessMapData.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.grasscutter.net.proto.activity.IrodoriChessMapData parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.grasscutter.net.proto.activity.IrodoriChessMapData) e.getUnfinishedMessage();
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        io.grasscutter.net.proto.multistage_play.IrodoriChessEntranceDetailInfo, io.grasscutter.net.proto.multistage_play.IrodoriChessEntranceDetailInfo.Builder, io.grasscutter.net.proto.multistage_play.IrodoriChessEntranceDetailInfoOrBuilder> entranceDetailInfoBuilder_;
    /**
     * <code>.IrodoriChessEntranceDetailInfo entrance_detail_info = 14;</code>
     * @return Whether the entranceDetailInfo field is set.
     */
     ...
     * <code>.IrodoriChessEntranceDetailInfo entrance_detail_info = 14;</code>
     */
    public Builder setEntranceDetailInfo(io.grasscutter.net.proto.multistage_play.IrodoriChessEntranceDetailInfo value) {
      if (entranceDetailInfoBuilder_ == null) {
        if (value == null) {
    ...
    public Builder setEntranceDetailInfo(
        io.grasscutter.net.proto.multistage_play.IrodoriChessEntranceDetailInfo.Builder builderForValue) {
      if (entranceDetailInfoBuilder_ == null) {
     ...
     * <code>.IrodoriChessEntranceDetailInfo entrance_detail_info = 14;</code>
     */
    public Builder mergeEntranceDetailInfo(io.grasscutter.net.proto.multistage_play.IrodoriChessEntranceDetailInfo value) {
      if (entranceDetailInfoBuilder_ == null) {
        if (entranceDetailInfo_ != null) {
          entranceDetailInfo_ =
            io.grasscutter.net.proto.multistage_play.IrodoriChessEntranceDetailInfo.newBuilder(entranceDetailInfo_).mergeFrom(value).buildPartial();
        } else {
          entranceDetailInfo_ = value;
        }
        onChanged();
     ...
     * <code>.IrodoriChessEntranceDetailInfo entrance_detail_info = 14;</code>
     */
    public io.grasscutter.net.proto.multistage_play.IrodoriChessEntranceDetailInfo.Builder getEntranceDetailInfoBuilder() {
    ...
    public io.grasscutter.net.proto.multistage_play.IrodoriChessEntranceDetailInfoOrBuilder getEntranceDetailInfoOrBuilder() {
      if (entranceDetailInfoBuilder_ != null) {
        ...
        return entranceDetailInfo_ == null ?
            io.grasscutter.net.proto.multistage_play.IrodoriChessEntranceDetailInfo.getDefaultInstance() : entranceDetailInfo_;
      }
    }
    /**
     * <code>.IrodoriChessEntranceDetailInfo entrance_detail_info = 14;</code>
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        io.grasscutter.net.proto.multistage_play.IrodoriChessEntranceDetailInfo, io.grasscutter.net.proto.multistage_play.IrodoriChessEntranceDetailInfo.Builder, io.grasscutter.net.proto.multistage_play.IrodoriChessEntranceDetailInfoOrBuilder> 
  ...
  private static final io.grasscutter.net.proto.activity.IrodoriChessMapData DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.grasscutter.net.proto.activity.IrodoriChessMapData();
  }

  public static io.grasscutter.net.proto.activity.IrodoriChessMapData getDefaultInstance() {
